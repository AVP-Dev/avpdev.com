export const mekohausTranslations = {
    ru: {
        case_mekohaus_h1_portfolio: 'B2B-портал для мебельной фабрики',
        case_mekohaus_title: 'Кейс: B2B-портал для мебельной фабрики | AVPdev Портфолио',
        case_mekohaus_h1: 'B2B-портал для мебельной фабрики',
        ...
        case_mekohaus_client: 'Мебельная фабрика',
        ...
        case_mekohaus_solution_p: 'Мы разработали полноценный B2B-портал с кастомной админ-панелью на PHP. Решение закрыло две задачи: удобное управление каталогом товаров и автоматическую передачу заявок дилеров менеджерам через Telegram-бот.',
    ...
    en: {
        case_mekohaus_h1_portfolio: 'B2B Portal for a Furniture Factory',
        case_mekohaus_title: 'Case: B2B Portal for a Furniture Factory | AVPdev Portfolio',
        case_mekohaus_h1: 'B2B Portal for a Furniture Factory',
        ...
        case_mekohaus_client: 'Furniture Factory',
        ...
        case_mekohaus_solution_p: 'We built a fully-featured B2B portal with a custom PHP admin panel. The solution covered two tasks: convenient product catalog management and automatic delivery of dealer inquiries to managers via a Telegram bot.',
