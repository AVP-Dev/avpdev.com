export const carsTranslations = {
    ru: {
        case_cars_h1_portfolio: 'Прозрачный расчет стоимости авто для импортера автомобилей',
    ...
    en: {
        case_cars_h1_portfolio: 'Transparent Car Cost Calculation for a Car Import Company',
        ...
        case_cars_client_portfolio: 'Car Import Company',
        case_cars_services_portfolio: 'Web Development, Frontend, Backend',
        case_cars_task_p_portfolio: 'The car import company faced client mistrust due to non-transparent pricing. Potential buyers did not understand how the final car price was formed, including customs duties, which created a barrier to ordering and required lengthy consultations from managers.',
