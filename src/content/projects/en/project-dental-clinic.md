...
content:
  task:
    titleKey: 'case_task'
    pKey: 'case_pure_trust_task_p'
  solution:
    titleKey: 'case_solution'
    pKey: 'case_pure_trust_solution_p'
  keyFeatures:
    titleKey: 'case_key_features'
    listKeys:
      - 'case_pure_trust_feat_1'
      - 'case_pure_trust_feat_2'
      - 'case_pure_trust_feat_3'
      - 'case_case_pure_trust_feat_4'
  techStack:
    - icon: 'fab fa-node-js'
      title: 'Astro 5'
      color: '#FF5D01'
  ...
  deployment:
    ...
    pKey: 'case_pure_trust_deployment_text'
  gallery:
