...
content:
  task:
    titleKey: 'case_task'
    pKey: 'case_ralf_ringer_task_p'
  solution:
    titleKey: 'case_solution'
    pKey: 'case_ralf_ringer_solution_p'
  keyFeatures:
    titleKey: 'case_key_features'
    listKeys:
      - 'case_ralf_ringer_feat_1'
      - 'case_ralf_ringer_feat_2'
      - 'case_ralf_ringer_feat_3'
      - 'case_ralf_ringer_feat_4'
  techStack:
    - icon: 'fab fa-node-js'
      title: 'Astro 5'
      color: '#FF5D01'
  ...
  deployment:
    ...
    pKey: 'case_ralf_ringer_deployment_text'
  gallery:
