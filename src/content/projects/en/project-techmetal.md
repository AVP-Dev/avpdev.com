...
content:
  task:
    titleKey: 'case_task'
    pKey: 'case_techmetal_task_p'
  solution:
    titleKey: 'case_solution'
    pKey: 'case_techmetal_solution_p'
  keyFeatures:
    titleKey: 'case_key_features'
    listKeys:
      - 'case_techmetal_feat_1'
      - 'case_techmetal_feat_2'
      - 'case_techmetal_feat_3'
      - 'case_case_techmetal_feat_4'
  techStack:
    - icon: 'fab fa-react'
      title: 'Next.js'
    - icon: 'fab fa-react'
  ...
  deployment:
    ...
    pKey: 'case_techmetal_deployment_text'
  gallery:
