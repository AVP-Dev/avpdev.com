...
content:
  task:
    titleKey: 'case_task'
    pKey: 'case_rozhkova_task_p'
  solution:
    titleKey: 'case_solution'
    pKey: 'case_rozhkova_solution_p'
  keyFeatures:
    titleKey: 'case_key_features'
    listKeys:
      - 'case_rozhkova_feat_1'
      - 'case_rozhkova_feat_2'
      - 'case_rozhkova_feat_3'
      - 'case_case_rozhkova_feat_4'
  techStack:
    - icon: 'fab fa-node-js'
      title: 'Astro 5'
      color: '#FF5D01'
  ...
  deployment:
    ...
    pKey: 'case_rozhkova_deployment_text'
  gallery:
