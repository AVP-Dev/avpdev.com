...
heroImageAlt: 'Aura Home - Архитектурный ИИ'
header:
...
content:
  task:
    titleKey: 'case_task'
    pKey: 'case_aura_home_task_p'
  solution:
    titleKey: 'case_solution'
    pKey: 'case_aura_home_solution_p'
  keyFeatures:
    titleKey: 'case_key_features'
    listKeys:
      - 'case_aura_home_feat_1'
      - 'case_aura_home_feat_2'
      - 'case_aura_home_feat_3'
      - 'case_aura_home_feat_4'
  techStack:
    - icon: 'fab fa-node-js'
      title: 'Astro 5'
      color: '#FF5D01'
  ...
  deployment:
    ...
    pKey: 'case_aura_home_deployment_text'
  gallery:
