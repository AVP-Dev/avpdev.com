...
heroImageAlt: 'Премиальные кожаные изделия ручной работы'
header:
...
content:
  task:
    titleKey: 'case_task'
    pKey: 'case_leder_werk_task_p'
  solution:
    titleKey: 'case_solution'
    pKey: 'case_leder_werk_solution_p'
  keyFeatures:
    titleKey: 'case_key_features'
    listKeys:
      - 'case_leder_werk_feat_1'
      - 'case_leder_werk_feat_2'
      - 'case_leder_werk_feat_3'
      - 'case_case_leder_werk_feat_4'
  techStack:
    - icon: 'fab fa-node-js'
      title: 'Astro 5'
      color: '#FF5D01'
  ...
  deployment:
    ...
    pKey: 'case_leder_werk_deployment_text'
  gallery:
