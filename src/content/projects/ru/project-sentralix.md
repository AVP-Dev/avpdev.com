...
heroImageAlt: 'Главный экран Enterprise SaaS-платформы'
header:
...
content:
  task:
    titleKey: 'case_task'
    pKey: 'case_sentralix_task_p'
  solution:
    titleKey: 'case_solution'
    pKey: 'case_sentralix_solution_p'
  keyFeatures:
    titleKey: 'case_key_features'
    listKeys:
      - 'case_sentralix_feat_1'
      - 'case_sentralix_feat_2'
      - 'case_sentralix_feat_3'
      - 'case_sentralix_feat_4'
      - 'case_sentralix_feat_5'
  techStack:
    - icon: 'fab fa-node-js'
      title: 'Astro 5'
      color: '#FF5D01'
  ...
  deployment:
    ...
    pKey: 'case_sentralix_deployment_text'
  gallery:
