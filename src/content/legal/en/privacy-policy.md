...
---
This Privacy Policy for personal data (hereinafter - the Policy) applies to all information that the self-employed individual **Patskevich Aliaksei**, UNP MA6914161 (hereinafter - the Administration), can obtain about the User while using the AVPdev.com website and its subdomains (hereinafter - the Site).
