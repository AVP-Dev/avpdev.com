...
$$\text{Идея} \longrightarrow \text{Архитектура} \longrightarrow \mathbf{\text{Написание кода (80\% времени)}} \longrightarrow \text{Code Review} \longrightarrow \text{Тесты} \longrightarrow \text{Production}$$
