...
export const allProjects: Project[] = [
    ...
    { id: 4, category: 'sites', img: '/images/tow-truck-hero.webp',     titleKey: 'case_tow_h1_portfolio',        link: '/project/project-tow-truck/', tags: ['HTML', 'CSS', 'JS', 'Telegram API'] },
    { id: 5, category: 'sites', img: '/images/project-3d-model.webp',   titleKey: 'case_3d_h1_portfolio',         link: '/project/project-3d-modeling/', tags: ['JavaScript', 'Three.js', 'HTML', 'CSS'] },
    { id: 6, category: 'sites',  img: '/images/project-mekohaus-hero.webp', titleKey: 'case_mekohaus_h1_portfolio',   link: '/project/project-mekohaus/',  tags: ['HTML', 'CSS', 'PHP'] },
];
