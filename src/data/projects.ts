...
export interface Project {
    ...
    img: string;
    titleKey: string;
    link: string; // Links updated
    tags: string[];
}

// FIX: Добавлен экспорт `allProjects`
export const allProjects: Project[] = [
    ...
    { id: 3, category: 'sites', img: '/images/cars-hero-portfolio.webp', titleKey: 'case_cars_h1_portfolio', link: '/project/project-cars',      tags: ['JavaScript', 'Node.js', 'PostgreSQL', 'Express'] },
    ...
    // FIX: Добавлены недостающие проекты
