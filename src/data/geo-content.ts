export const geoContent: { [key: string]: { [lang: string]: { title: string; description: string; h1: string; p: string; } } } = {
  'minsk': {
    'ru': {
      title: 'Создание сайтов в Минске | Профессиональная веб-разработка',
      description: 'Заказать разработку сайта в Минске. Создаем быстрые, современные и продающие сайты для бизнеса. Полный цикл услуг от AVPdev.',
      h1: 'Разработка сайтов в Минске',
      p: 'Ищете надежного партнера для создания сайта в столице Беларуси? Мы предлагаем полный спектр услуг по веб-разработке в Минске, от лендингов до сложных корпоративных порталов.'
    },
    'en': {
      title: 'Website Development in Minsk | Professional Web Services',
      description: 'Order website development in Minsk. We create fast, modern, and sales-driven websites for business. Full-cycle services from AVPdev.',
      h1: 'Web Development in Minsk',
      p: 'Looking for a reliable partner to create a website in the capital of Belarus? We offer a full range of web development services in Minsk, from landing pages to complex corporate portals.'
    }
  },
  'gomel': {
    'ru': {
      title: 'Разработка сайтов в Гомеле | Заказать сайт для бизнеса',
      description: 'Нужен сайт в Гомеле? Предлагаем услуги по созданию сайтов и веб-приложений. Поможем вашему бизнесу выйти на новый уровень в Гомельском регионе.',
      h1: 'Создание сайтов для бизнеса в Гомеле',
      p: 'Развиваете бизнес в Гомеле и Гомельской области? Качественный сайт — ваш главный инструмент для привлечения клиентов. Мы специализируемся на создании адаптивных и быстрых сайтов.'
    },
    'en': {
      title: 'Web Development in Gomel | Order a Business Website',
      description: 'Need a website in Gomel? We offer website and web application development services. We will help your business reach a new level in the Gomel region.',
      h1: 'Business Website Creation in Gomel',
      p: 'Developing a business in Gomel and the Gomel region? A quality website is your main tool for attracting customers. We specialize in creating responsive and fast websites.'
    }
  },
  'mogilev': {
    'ru': {
  ...
  'moscow': {
    'ru': {
      title: 'Разработка сайтов в Москве | Веб-студия AVPdev',
      description: 'Заказать создание сайта в Москве. Профессиональная разработка сайтов для бизнеса. SEO-оптимизация и современные технологии.',
      h1: 'Создание сайтов в Москве',
      p: 'Наша команда предлагает высококлассные услуги по разработке сайтов в Москве. Мы помогаем компаниям завоевывать столичный рынок.'
    },
    'en': {
      title: 'Website Development in Moscow | AVPdev Web Studio',
      description: 'Order website creation in Moscow. Professional business website development. SEO optimization and modern technologies.',
      h1: 'Website Creation in Moscow',
      p: 'Our team offers high-class website development services in Moscow. We help companies conquer the capital\'s market.'
    }
  },
  'saint-petersburg': {
    'ru': {
