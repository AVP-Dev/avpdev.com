...
export interface CaseStudy {
  slug: string;
  // Метаданные для SEO и OG-тегов
  titleKey: string;
  descriptionKey: string;
  ogImage: string;
  // Данные для "шапки" кейса
  clientKey: string;
  servicesKey: string;
  year: number;
  heroImage: string;
  heroImageAlt: string;
  // Данные для заголовка на самой странице
  header: {
    titleKey: string;
    descriptionKey: string;
  };
  ...
  content: {
    task: { titleKey: string; pKey: string; };
    solution?: { titleKey: string; pKey: string; };
    keyFeatures: { titleKey: string; pKey?: string; listKeys: string[]; };
    techStack: { icon: string; title: string; }[];
    deployment: { titleKey: string; pKey: string; };
    gallery?: {
      titleKey: string;
      items: { img: string; captionKey: string; }[];
    };
  };
}
...
export const caseStudies: CaseStudy[] = [
  // 1. Проект: Мебель (Terra Forma)
  {
    ...
    content: {
      ...
      solution: { titleKey: 'case_furniture_solution_title', pKey: 'case_furniture_solution_p' },
      keyFeatures: { 
        titleKey: 'case_key_features', 
        listKeys: [
          'case_furniture_features_li1_short', 'case_furniture_features_li2_short', 
          'case_furniture_features_li3_short', 'case_furniture_features_li4_short',
          'case_furniture_features_li5_short', 'case_furniture_features_li6_short'
        ] 
      },
      techStack: [
      ...
      deployment: { titleKey: 'case_deployment_title', pKey: 'case_furniture_deployment_text' },
      gallery: {
  ...
  // 2. Проект: Туризм (Happy Tour)
  {
    ...
    content: {
      ...
      solution: { titleKey: 'case_travel_solution_title', pKey: 'case_travel_solution_p' },
      keyFeatures: {
        titleKey: 'case_key_features',
        listKeys: ['case_travel_solution_li1', 'case_travel_solution_li2', 'case_travel_solution_li3', 'case_travel_solution_li4']
      },
      techStack: [
        { icon: 'fab fa-react', title: 'Next.js / React' },
        { icon: 'fas fa-bolt', title: 'Chakra UI' },
        ...
        { icon: 'fab fa-telegram-plane', title: 'Telegram & Bitrix24 Integration' }
      ],
      deployment: { titleKey: 'case_deployment_title', pKey: 'case_deployment_text' },
      gallery: {
        titleKey: 'project_fragments_title',
        items: [
  ...
  // 3. Проект: Авто (АвтоМир Импорт)
  {
    ...
    header: { titleKey: 'case_cars_h1_portfolio', descriptionKey: 'case_cars_desc_portfolio' },
    content: {
      task: { titleKey: 'case_task', pKey: 'case_cars_task_p_portfolio' },
      solution: { titleKey: 'case_cars_solution_title', pKey: 'case_cars_solution_p' },
      keyFeatures: {
        titleKey: 'case_key_features',
        listKeys: [
          'case_cars_solution_li1_portfolio', 'case_cars_solution_li2_portfolio',
          'case_cars_solution_li3_portfolio', 'case_cars_solution_li4_portfolio',
          'case_cars_solution_li5_portfolio', 'case_cars_solution_li6_portfolio'
        ]
      },
      techStack: [
        ...
        { icon: 'fab fa-python', title: 'Python (для бэкенда калькулятора)' }
      ],
      deployment: { titleKey: 'case_deployment_title', pKey: 'case_cars_deployment_text' },
      gallery: {
        titleKey: 'project_fragments_title',
        items: [
  ...
  // 4. Проект: Эвакуатор
  {
    ...
    content: {
      ...
      solution: { titleKey: 'case_tow_solution_title', pKey: 'case_tow_solution_p' },
      keyFeatures: {
        titleKey: 'case_key_features',
        pKey: 'case_tow_features_p',
        listKeys: ['case_tow_solution_li1', 'case_tow_solution_li2', 'case_tow_solution_li3']
      },
      techStack: [
        { icon: 'fab fa-html5', title: 'HTML5' },
        { icon: 'fab fa-css3-alt', title: 'CSS3' },
      ...
      deployment: { titleKey: 'case_deployment_title', pKey: 'case_tow_deployment_text' },
      gallery: {
        titleKey: 'project_fragments_title',
        items: [
  ...
  // 5. Проект: 3D-моделирование
  {
    ...
    content: {
      ...
      keyFeatures: {
        ...
        listKeys: [
          'case_3d_solution_li1', 'case_3d_solution_li2', 'case_3d_solution_li3',
          'case_3d_solution_li4', 'case_3d_solution_li5', 'case_3d_solution_li6', 'case_3d_solution_li7'
        ]
      },
      techStack: [
        { icon: 'fab fa-html5', title: 'HTML5' },
        ...
        { icon: 'fab fa-docker', title: 'Docker' },
        { icon: 'fas fa-server', title: 'Coolify & VPS' },
  ...
  // 6. Проект: Mekohaus
  {
    ...
    header: { titleKey: 'case_mekohaus_h1', descriptionKey: 'case_mekohaus_desc' },
    content: {
      task: { titleKey: 'case_task', pKey: 'case_mekohaus_task_p' },
      keyFeatures: {
        titleKey: 'case_key_features',
        listKeys: [
          'case_mekohaus_solution_li1', 'case_mekohaus_solution_li2', 'case_mekohaus_solution_li3',
          'case_mekohaus_solution_li4', 'case_mekohaus_solution_li5'
        ]
      },
      techStack: [
        { icon: 'fab fa-html5', title: 'HTML5' },
